--[[
    ...
    Important observations:
      ...
      [2] TODO. Add other observations to help users understand at a high level this module
--]]
  ...
  if (not self.predict) then -- Training or evaluation
    ...
    for i, node_step in ipairs(node_traversal) do
      ...
      if self.train ~= false then
        ...
        -- FIXME: Im doing getStepModule to avoid a bug, this is not very efficient.
...
function DRNN:forget()
  ...
  -- so we don't want to get rid of the state passed by encoder.
end
